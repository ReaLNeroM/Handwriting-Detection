...
image_list = decoder.ImagePack(image_data_location=dir_path + '/train-images.idx3-ubyte',
                               label_data_location=dir_path + '/train-labels.idx1-ubyte')
...
try:
    ...
    neural_net = neural_network.NeuralNetwork(network_shape=(input_neurons,
                                                             int((input_neurons * labels) ** 0.5),
                                                             labels))
